...
class UdemyCoursesSearchBLOC with ChangeNotifier
{
  ...
  Future<List> getData() async
  {
    ...
    snap.addAll(rawData.docs.where((u) => (u['COURSE NAME'].toLowerCase().contains(_searchText.toLowerCase()) || u['DESCRIPTION'].toLowerCase().contains(_searchText.toLowerCase()))));
    data = snap.map((e) => UdemyCoursesModel.fromFirestore(e)).toList();
    return data;
  }
